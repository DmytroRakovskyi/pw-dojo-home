...
test.describe(
  "Xpath 002, checkbox functionality",
  { tag: ["@smoke", "@checkbox"] },
  () => {
    ...
    test(
      `demoqa-2, checkbox functionality`,
      { tag: ["@smoke", "@checkbox"] },
      async ({ page }) => {
        //headers
        ...
        const desktop: Locator = page.locator(
          "//*[contains(text(), 'Desktop')]",
        );
        const documents: Locator = page.locator(
          "//*[contains(text(), 'Documents')]",
        );
        const downloads: Locator = page.locator(
        ...
        const collapseButton = page.locator(
          "//button[contains(@aria-label, 'Collapse')]",
        );
        const homeButton: Locator = page.locator(
          "//*[contains(text(), 'Home')]/../../button",
        );
        const desktopButton: Locator = page.locator(
          "//*[contains(text(), 'Desktop')]/../../button",
        );
